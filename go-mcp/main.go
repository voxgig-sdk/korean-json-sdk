// Command KoreanJson-mcp is an MCP server exposing the KoreanJson
// SDK as MCP tools.
//
// Two tools are registered:
//
//	KoreanJson_list  — list records of an entity
//	KoreanJson_load  — load a single record of an entity
//
