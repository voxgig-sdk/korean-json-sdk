...
type Args struct {
	Entity string         `json:"entity" jsonschema:"comment | post | todo | user"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.KoreanJsonSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "korean-json_list",
		Description: "List records from KoreanJson. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "korean-json_load",
		Description: "Load a single record from KoreanJson. " +
...
func runOp(client *sdk.KoreanJsonSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.KoreanJsonSDK, name string) (sdk.KoreanJsonEntity, error) {
