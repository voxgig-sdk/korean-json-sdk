...
describe("TodoEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set KOREAN_JSON_TEST_TODO_ENTID JSON to run live")
      return
    end
...
function todo_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("KOREAN_JSON_TEST_TODO_ENTID")
