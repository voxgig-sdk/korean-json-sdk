...
describe("CommentEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set KOREAN_JSON_TEST_COMMENT_ENTID JSON to run live")
      return
    end
...
function comment_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("KOREAN_JSON_TEST_COMMENT_ENTID")
  ...
  local idmap_resolved = helpers.to_map(
    env["KOREAN_JSON_TEST_COMMENT_ENTID"])
