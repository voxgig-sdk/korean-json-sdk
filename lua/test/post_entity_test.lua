...
describe("PostEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set KOREAN_JSON_TEST_POST_ENTID JSON to run live")
      return
    end
    ...
    local post_ref01_markdef_up0_name = "content"
...
function post_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("KOREAN_JSON_TEST_POST_ENTID")
  ...
  local idmap_resolved = helpers.to_map(
    env["KOREAN_JSON_TEST_POST_ENTID"])
