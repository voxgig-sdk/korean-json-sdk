...
function runner.env_override(m)
  local live = runner.getenv("KOREAN_JSON_TEST_LIVE")
  local override = runner.getenv("KOREAN_JSON_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("KOREAN_JSON_TEST_EXPLAIN")
