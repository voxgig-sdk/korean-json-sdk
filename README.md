...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/korean-json` | `npm install @voxgig-sdk/korean-json` |
| Python | `voxgig-sdk-korean-json` | `pip install voxgig-sdk-korean-json` |
| PHP | `voxgig-sdk/korean-json` | `composer require voxgig-sdk/korean-json` |
| Golang | `github.com/voxgig-sdk/korean-json-sdk/go` | `go get github.com/voxgig-sdk/korean-json-sdk/go` |
| Ruby | `voxgig-sdk-korean-json` | `gem install voxgig-sdk-korean-json` |
| Lua | `voxgig-sdk-korean-json` | `luarocks install voxgig-sdk-korean-json` |
