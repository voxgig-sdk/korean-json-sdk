...
(0, node_test_1.describe)('PostDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.KoreanJsonSDK({
...
function liveScenariosActive() { return false && process.env.KOREAN_JSON_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'KOREAN_JSON_TEST_POST_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.KoreanJsonSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['KOREAN_JSON_TEST_POST_ENTID'];
    ...
    const client = new __1.KoreanJsonSDK({
        base: 'http://localhost:8080',
