...
function envOverride(m) {
    if ('TRUE' === process.env.KOREAN_JSON_TEST_LIVE ||
        'TRUE' === process.env.KOREAN_JSON_TEST_OVERRIDE) {
    ...
    m.KOREAN_JSON_TEST_EXPLAIN = process.env.KOREAN_JSON_TEST_EXPLAIN || m.KOREAN_JSON_TEST_EXPLAIN;
    return m;
}
