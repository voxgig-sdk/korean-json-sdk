...
func registerSDKWords(r *eng.Registry, client *sdk.KoreanJsonSDK) {
...
func runOp(client *sdk.KoreanJsonSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
