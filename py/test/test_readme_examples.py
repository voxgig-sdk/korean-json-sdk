# KoreanJson SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions KoreanJsonSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both KoreanJsonSDK(...) and KoreanJsonSDK.test(...) become
#      KoreanJsonSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "koreanjson_sdk"
_SDK_CLASS = "KoreanJsonSDK"
