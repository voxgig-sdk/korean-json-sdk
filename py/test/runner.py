...
class KoreanJsonTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = KoreanJsonTestRunner.getenv("KOREANJSON_TEST_LIVE")
        override = KoreanJsonTestRunner.getenv("KOREANJSON_TEST_OVERRIDE")
        ...
        explain = KoreanJsonTestRunner.getenv("KOREANJSON_TEST_EXPLAIN")
