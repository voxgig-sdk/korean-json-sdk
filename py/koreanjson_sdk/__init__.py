...
from koreanjson_sdk.utility import register

# Load features
from koreanjson_sdk.feature.base_feature import KoreanJsonBaseFeature
from koreanjson_sdk.features import _has_feature, _make_feature
...
class KoreanJsonSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = KoreanJsonUtility()
        self._utility = utility

        from koreanjson_sdk.config import shared_config
    ...
    def get_utility(self):
        return KoreanJsonUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("KoreanJsonSDK: graphql: " + str(msg))
            res["graphql"] = errors
