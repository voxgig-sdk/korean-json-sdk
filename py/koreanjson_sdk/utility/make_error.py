# KoreanJson SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, KoreanJsonError):
        errmsg = err.msg
    ...
    msg = "KoreanJsonSDK: " + opname + ": " + errmsg
    ...
    sdk_err = KoreanJsonError("", msg, ctx)
