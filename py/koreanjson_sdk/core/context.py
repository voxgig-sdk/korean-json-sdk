...
from koreanjson_sdk.core.control import KoreanJsonControl
...
from koreanjson_sdk.core.helpers import get_ctx_prop, to_map
...
class KoreanJsonContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, KoreanJsonSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, KoreanJsonResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, KoreanJsonResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return KoreanJsonError(code, msg, self)
