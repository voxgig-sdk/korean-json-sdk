...
class UserEntity
  ...
  # @return [User, Hash] the loaded User; raises KoreanJsonError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<User>, Array] the matching User items; raises KoreanJsonError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [User, Hash] the created User; raises KoreanJsonError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [User, Hash] the updated User; raises KoreanJsonError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [User, Hash] the removed User; raises KoreanJsonError on failure
