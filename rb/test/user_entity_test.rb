...
class UserEntityTest < Minitest::Test
  ...
  def test_stream
    ...
    base = KoreanJsonSDK.test(seed, nil)
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set KOREAN_JSON_TEST_USER_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def user_basic_setup(extra)
  ...
  entid_env_raw = ENV["KOREAN_JSON_TEST_USER_ENTID"]
