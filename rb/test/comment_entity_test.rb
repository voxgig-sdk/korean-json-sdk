...
class CommentEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set KOREANJSON_TEST_COMMENT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def comment_basic_setup(extra)
  ...
  entid_env_raw = ENV["KOREANJSON_TEST_COMMENT_ENTID"]
