...
|---|---|---|
| `ts/` | @voxgig-sdk/korean-json-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/korean-json-sdk \
      --repository voxgig-sdk/korean-json-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/korean-json-sdk` shows it, and
`npm trust revoke @voxgig-sdk/korean-json-sdk --id=<id>` removes it.
