...
// KoreanJson SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = KoreanJsonOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(KoreanJsonOmni::structfix($now, Struct::undef()))
                        !== json_encode(KoreanJsonOmni::structfix($val, Struct::undef()))) {
