...
// KoreanJson SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class KoreanJsonMakeRequest
{
    public static function call(KoreanJsonContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new KoreanJsonResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new KoreanJsonResponse($fetched);
        } else {
