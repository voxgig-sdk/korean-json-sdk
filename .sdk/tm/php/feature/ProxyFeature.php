...
class KoreanJsonProxyFeature extends KoreanJsonBaseFeature
{
    ...
    public function init(KoreanJsonContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (KoreanJsonContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
