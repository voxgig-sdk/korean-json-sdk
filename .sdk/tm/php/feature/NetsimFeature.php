...
class KoreanJsonNetsimFeature extends KoreanJsonBaseFeature
{
    ...
    private function _simulate(KoreanJsonContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(KoreanJsonContext $ctx, array $applied): void
    {
        $client = $this->client;
