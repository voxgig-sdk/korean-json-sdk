...
class KoreanJsonRbacFeature extends KoreanJsonBaseFeature
{
    ...
    private function _required(KoreanJsonContext $ctx): ?string
    {
    ...
    private function _reject(KoreanJsonContext $ctx, string $required): void
    {
    ...
    private function _track(KoreanJsonContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
