...
// KoreanJson SDK clienttrack feature
...
class KoreanJsonClienttrackFeature extends KoreanJsonBaseFeature
{
    ...
    public function PostConstruct(KoreanJsonContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'KoreanJson-SDK';
