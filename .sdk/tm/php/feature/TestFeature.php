...
// KoreanJson SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class KoreanJsonTestFeature extends KoreanJsonBaseFeature
{
    ...
    public function init(KoreanJsonContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (KoreanJsonContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = KoreanJsonParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (KoreanJsonContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(KoreanJsonContext $ctx, $op, $args): array
    {
