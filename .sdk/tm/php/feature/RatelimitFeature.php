...
// KoreanJson SDK ratelimit feature
...
class KoreanJsonRatelimitFeature extends KoreanJsonBaseFeature
{
    ...
    private function _acquire(KoreanJsonContext $ctx): void
    {
    ...
    private function _track(KoreanJsonContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
