...
// KoreanJson SDK idempotency feature
...
class KoreanJsonIdempotencyFeature extends KoreanJsonBaseFeature
{
    ...
    private function _mutating(KoreanJsonContext $ctx): bool
    {
