...
// KoreanJson SDK telemetry feature
...
class KoreanJsonTelemetryFeature extends KoreanJsonBaseFeature
{
    ...
    private function _close(KoreanJsonContext $ctx, bool $ok): void
    {
