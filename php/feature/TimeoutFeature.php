...
// KoreanJson SDK timeout feature
...
class KoreanJsonTimeoutFeature extends KoreanJsonBaseFeature
{
    ...
    private function _with_timeout(KoreanJsonContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(KoreanJsonContext $_ctx, float $ms): void
    {
        $client = $this->client;
