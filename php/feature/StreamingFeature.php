...
// KoreanJson SDK streaming feature
...
class KoreanJsonStreamingFeature extends KoreanJsonBaseFeature
{
    ...
    private function _iterate(KoreanJsonResult $result): \Generator
    {
    ...
    private function _streamable(KoreanJsonContext $ctx): bool
    {
