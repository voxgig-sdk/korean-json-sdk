...
class KoreanJsonCacheFeature extends KoreanJsonBaseFeature
{
    ...
    private function _through(KoreanJsonContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
