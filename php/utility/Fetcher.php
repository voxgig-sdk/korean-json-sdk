...
// KoreanJson SDK utility: fetcher

class KoreanJsonFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; KoreanJsonSDK/1.0)';
    ...
    public static function call(KoreanJsonContext $ctx, string $fullurl, array $fetchdef): array
    {
