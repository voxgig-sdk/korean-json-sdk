...
// KoreanJson SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class KoreanJsonTransformResponse
{
    public static function call(KoreanJsonContext $ctx): mixed
    {
        ...
        $transform = KoreanJsonHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
