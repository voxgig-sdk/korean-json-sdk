...
// KoreanJson SDK utility: graphql
//
...
class KoreanJsonGraphql
{
    ...
    // equivalent.
    public static function body(KoreanJsonContext $ctx): mixed
    {
    ...
    public static function errors(KoreanJsonContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
