...
class TodoEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set KOREANJSON_TEST_TODO_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function todo_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("KOREANJSON_TEST_TODO_ENTID");
