...
// KoreanJson SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (KoreanJsonSDK::test)
...
{
    private const SDK_CLASS = 'KoreanJsonSDK';
    ...
    private const SDK_BASE = 'koreanjson_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../koreanjson_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
